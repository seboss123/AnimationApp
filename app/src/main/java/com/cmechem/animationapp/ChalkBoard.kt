...
class ChalkBoard//Constructor - initialize this View
    ...
    private var startX = 250.0f  //left-most x-coordinate
    ...
    private var fraction =
        1.0f      //fraction of distance from old rectangle to new one at each step of animation
    private var colorFraction =
        1.0f    //fraction of distance from old color to new one at each step of animation
